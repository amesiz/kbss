...
include "inc/dbcon.php";
	...
	$pership = $_POST['pership'];
	//$fcl20n = $_POST['fcl20n'];
	//$fcl40 = $_POST['fcl40'];
	//$fcl40n = $_POST['fcl40n'];
	//$lcl = $_POST['lcl'];
	//$lcl2 = $_POST['lcl2'];
	$pership_no = $_POST['pership_no'];
	$job_no = $_POST['job_no'];
	$inv_no = $_POST['inv_no'];
	$ship = 1;
...
//$e = date("Y-m-d", $d);
	...
	$sql = "insert into itempership (itempership_no, pership, ship, pership_no, job_no, inv_no) values ('','$pership','$ship','$pership_no','$job_no','$inv_no')";
