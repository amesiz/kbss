    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
                <form action="itemorder_add2.php" name="frmMain" method="post" target="iframe_target">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <select class="form-control" id="ordera_no" name="ordera_no">
                                                    <?php
                                                        include "inc/dbcon.php";
                                                        $sql1="SELECT * FROM ordera WHERE inv_no='$inv_no'";
                                                        $result1 = mysqli_query($con,$sql1);
                                                        while($row1 = mysqli_fetch_array($result1)){
                                                        $ordera_no = $row1['ordera_no'];
                                                        $ordera_name = $row1['ordera_name'];
                                                        $ordera1 = $row1['ordera1'];
                                                        echo "<option value='$ordera_no'>$ordera_name ($ordera1 บาท)</option>";
                                                        }
                                                    mysqli_close($con);
                                                    ?>
                                                </select>
