        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-6">
                    ...
                    <form action="jobuser_add2.php" name="frmMain" method="post" target="iframe_target">
                        ...
                        <div class="form-group">
                             <label>Invoice</label>
                                <select class="form-control" id="user_no" name="user_no">
                                    <?php while($row = mysqli_fetch_array($result)) { ?>
                                    <option value="<?php echo $row['user_no']; ?>"><?php echo $row['user_name']; ?></option>
                                    <?php } ?>
                                </select>
