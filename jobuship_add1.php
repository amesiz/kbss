        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-6">
                    ...
                    <form action="jobuship_add2.php" name="frmMain" method="post" target="iframe_target">
                        ...
                        include "inc/dbcon.php";
                        $cus_no = $_GET['cus_no'];
                        $result = mysqli_query($con,"SELECT * FROM uship");
                        ?>
                        <div class="form-group">
                             <label>Invoice</label>
                                <select class="form-control" id="uship_no" name="uship_no">
                                    <?php while($row = mysqli_fetch_array($result)) { ?>
                                    <option value="<?php echo $row['uship_no']; ?>"><?php echo $row['uship_name']; ?></option>
                                    <?php } ?>
                                </select>
