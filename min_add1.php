...
//                                        echo "</tr>";
echo "<a href='invdetail.php?inv_no=$inv_no'>$inv_name</a>";
//mysqli_close($con);
//include "bot.php";
?>   
                            </small>
                ...
                <!-- /.row -->
                <form action="min_add2.php" name="frmMain" method="post" target="iframe_target">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                                <label>บริการ</label>
                                <input class="form-control" placeholder="Enter text" id="min_name" name="min_name">
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Number"  id="min1" name="min1">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>CBM or TON</td>
                                        <td>บาท/CBM or TON</td>

                                        <td>
                                            <div class="form-group input-group">
                                                <span class="input-group-addon"><i class="fa fa-btc"></i></span>
                                                <input type="text" class="form-control" placeholder="Enter Number"  id="min2" name="min2">
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
