...
?>   
                ...
                <div class="col-lg-6">
                    ...
                    <form action="cuscontact_add2.php" name="frmMain" method="post" target="iframe_target">
                        ...
                        <div class="form-group">
                             ...
                             <input class="form-control" placeholder="Enter text" id="cuscontact_name" name="cuscontact_name">
                        </div>
                        <div class="form-group">
                             <label>Tel.</label>
