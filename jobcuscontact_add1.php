        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-6">
                    ...
                    <form action="jobcuscontact_add2.php" name="frmMain" method="post" target="iframe_target">
                        ...
                        <div class="form-group">
                             <label>ผู้ติดต่อ</label>
                                <select class="form-control" id="cuscontact_no" name="cuscontact_no">
                                    <?php while($row = mysqli_fetch_array($result)) { ?>
                                    <option value="<?php echo $row['cuscontact_no']; ?>"><?php echo $row['cuscontact_name']; ?></option>
                                    <?php } ?>
                                </select>
