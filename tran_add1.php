...
?>   
                ...
                <!-- /.row -->
                <form action="tran_add2.php" name="frmMain" method="post" target="iframe_target">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <!-- label>บริการ</label> -->
                                                <input class="form-control" placeholder="Enter text" id="tran1_name" name="tran1_name">
                                            </div>
                                        </td>
                                        </td>
                                        <td>บาท/เที่ยว
                                        ...
                                        <td>
                                            <div class="form-group input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Number"  id="tran1" name="tran1">
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
