    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
                <form action="itemorder2_add2.php" name="frmMain" method="post" target="iframe_target">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <select class="form-control" id="o2_no" name="o2_no">
                                                    <?php
                                                        include "inc/dbcon.php";
                                                        $sql1="SELECT * FROM o2 WHERE inv_no='$inv_no'";
                                                        ...
                                                        $o1 = $row1['o1'];
                                                        $o2 = $row1['o2'];
                                                        echo "<option value='$o2_no'>$o2_name ($o1 บาท)($o2 %)</option>";
                                                        }
                                                    mysqli_close($con);
                                                    ?>
                                                </select>
                                        ...
                                        <td><input type="text" class="form-control" placeholder="Enter Number"  id="itemorder2" name="itemorder2"></td>
                                    </tr>
