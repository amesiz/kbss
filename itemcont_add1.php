    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
                <form action="itemcont_add2.php" name="frmMain" method="post" target="iframe_target">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>FCL 20 ฟุต</td>
                                        <td><?php echo($fcl20f); ?></td>
                                        <td><?php echo($fcl20n); ?></td>
                                        <td>
                                            <div class="form-group">
                                                
                                                <input type="text" class="form-control" placeholder="Enter Number"  id="fcl20" name="fcl20">
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>FCL 40 ฟุต</td>
                                        <td><?php echo($fcl40f); ?></td>
                                        <td><?php echo($fcl40n); ?></td>
                                        <td>
                                            <div class="form-group">
                                                
                                                <input type="text" class="form-control" placeholder="Enter Number"  id="fcl40" name="fcl40">
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>LCL (KG.)</td>
                                        <td>(< 10,000 ก.ก.) <?php echo($lcl1); ?></td>
                                        <td>(> 10,000 ก.ก.) <?php echo($lcl2); ?></td>
                                        <td>
                                            <div class="form-group">
                                                
                                                <input type="text" class="form-control" placeholder="Enter Number"  id="lcl" name="lcl">
                                            </div>
                                        </td>
                                    </tr>
